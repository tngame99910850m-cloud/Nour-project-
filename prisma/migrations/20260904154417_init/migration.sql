-- CreateEnum
CREATE TYPE "Role" AS ENUM ('OWNER', 'ADMIN', 'STAFF', 'DEVELOPER');

-- CreateEnum
CREATE TYPE "CategoryGroup" AS ENUM ('WEDDING', 'HOME', 'OTHER');

-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('RECEIVED', 'SALE', 'ADJUSTMENT', 'RETURN', 'DAMAGED', 'CORRECTION');
